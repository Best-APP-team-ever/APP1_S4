...
class ExecOperation:
    ...
    def run_op(self, cip: str) -> None:
        ...
        if self.exec_flag:
            ...
            print(exec_pre_print)
            if self.exec_has_param:
                self.exec_func(cip)
            else:
                self.exec_func()
            print(exec_post_print, end="")
        return
...
class CommandTextan:
    ...
    def exec_operations(self, cip: str) -> None:
        ...
        for operation in self.operations:
            ...
            operation.run_op(cip)
            print(f" en {self.debug_handler.stop_execution_timing2():.2f} secondes")
        return
    ...
    def register_one_operation(self,
        ...
        """
        new_op = ExecOperation(exec_flag, exec_pre_print, exec_func, exec_has_param, exec_post_print)
